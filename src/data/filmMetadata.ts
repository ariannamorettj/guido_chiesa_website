...
export const filmMetadata: Record<string, FilmMetadata> = {
  ...
  'fragole-celesti': {
    ...
    linkEsterni: [
      { label: 'Link esterno', url: 'https://www.cinemaitaliano.info/fragolecelesti', type: 'site' },
    ],
  },
  ...
  'quei-momenti-eroici': {
    ...
    presentazione: 'Girato senza budget, in Super8 a New York nel 1988 (ad esclusione del brano di Nick Cave con Cristiano Godano dei Marlene Kuntz, girato in 16 mm. sette anni più tardi) e finito di montare nel 1995 in Italia con abbondante aggiunta di materiale d\'archivio. Sette canzoni celebri, sette solitudini, sette storie di personaggi che credono troppo alle canzoni che ascoltano, sette (falsi) video musicali che narrano di quei momenti in cui si è così soli che non fa nemmeno male esistere.',
    noteDiRegia: 'Chi si prende troppo sul serio è perduto, ma chi non ci prova nemmeno a prendere qualcosa sul serio non sa che cosa vuol dire vivere. Col senno del poi, questo lavoro segna una graduale presa di distanza dal rock e dalla sua mitologia adolescenziale. Al momento, fu un grande divertimento.',
    scheda: {
      sceneggiatura: 'Guido Chiesa',
      produzione: 'Cross Production, Brooklin Films',
      produttore: 'Christine Vachon, Michael Solomon',
      interpreti: 'James Smith, Chuck De Cuir, Guido Chiesa, Trula Hoosier, Michael Pyrnick, Rebecca Moore, Cristiano Godano, Monica Merlo',
      fotografia: 'Les Japan (fotografia per "By The Time I Get To Phoenix": Gherardo Gossi)',
  ...
  'give-me-spell': {
    ...
    linkEsterni: [
      { label: 'Link esterno', url: 'https://www.torinofilmfest.org/it/3-festival-internazionale-cinema-giovani/film/give-me-a-spell/5052/', type: 'site' },
    ],
  },
  ...
  'sono-stati-loro-48-ore-novi-ligure': {
    ...
    linkEsterni: [
      { label: 'Link esterno', url: 'https://www.cinemaitaliano.info/sonostatiloro', type: 'site' },
    ],
  },
  ...
  'kishe-ione-la-nostra-chiesa': {
    ...
    linkEsterni: [
      { label: 'Link esterno', url: 'https://www.cinemaitaliano.info/lanostrachiesa', type: 'site' },
    ],
  },
  ...
  'partigiani': {
    ...
    fotoGalleria: true,
    linkEsterni: [
      { label: 'Link esterno', url: 'https://www.torinofilmfest.org/it/16-torino-film-festival/film/partigiani/1186/', type: 'site' },
    ],
  },
  ...
  'il-contratto': {
    ...
    linkEsterni: [
      { label: 'Link esterno', url: 'https://www.cinematografo.it/film/il-contratto-n6tbv7hs', type: 'site' },
    ],
  },
  ...
  'alice-e-paradiso': {
    ...
    linkEsterni: [
      { label: 'Link esterno', url: 'https://www.cinemaitaliano.info/aliceeinparadiso', type: 'site' },
  ...
  'ma-che-ci-faccio-io-sanremo': {
    ...
    noteDiRegia: 'Un divertissement senza ambizioni.',
    scheda: {
      regia: 'Guido Chiesa',
      sceneggiatura: 'Guido Chiesa',
      produzione: 'Colorado Film per Tele+',
      montaggio: 'Luca Gasparini',
      durata: '55 minuti',
      genere: 'Documentario',
    },
  ...
  'provini-un-massacro': {
    ...
    noteDiRegia: 'Ho un rapporto ambiguo e contraddittorio con l\'opera di Pasolini, ma Salò rimane uno dei 4-5 film che indico quando mi chiedono "il tuo film preferito". È uno dei miei lavori a cui sono più legato perché sfugge all\'ideologia e cerca di ascoltare con pietas le nuove vittime della de-umanizzazione del materialismo consumista.',
  ...
  'una-questione-privata-vita-di-beppe-fenoglio': {
    ...
    presentazione: 'Sullo sfondo di un\'Alba provinciale e conservatrice, i racconti di chi ha conosciuto Beppe Fenoglio (10 mesi di lavoro e quasi 200 interviste) permettono di ricostruirne la personalità, il rapporto con la città, le donne (in particolare con Fulvia, il suo primo amore, e con Luciana Bombardi, la donna che sposò), l\'esperienza partigiana, l\'impegno civile dopo la guerra, le opere letterarie, i legami con gli altri intellettuali, le passioni, la malattia e la morte.',
    noteDiRegia: 'Credo che se mi sono occupato così tanto di Fenoglio, non è stato per la Resistenza o per le comuni radici piemontesi, ma perché mi ha permesso di fare i conti con una parte di me. Il migliore scrittore italiano del \'900, comunque, a mio modesto avviso.',
    ...
    linkEsterni: [
      { label: 'Link esterno', url: 'https://www.torinocittadelcinema.it/schedafilm.php?film_id=548&stile=small', type: 'site' },
    ],
  },
  ...
  'un-giorno-di-fuoco': {
    ...
    linkEsterni: [
      { label: 'Link esterno', url: 'https://www.torinocittadelcinema.it/schedafilm.php?film_id=522&stile=small', type: 'site' },
    ],
  },
  ...
  'nascita-di-una-democrazia': {
    ...
    linkEsterni: [
      { label: 'Link esterno', url: 'https://www.torinocittadelcinema.it/schedafilm.php?film_id=536&stile=small', type: 'site' },
    ],
  },
  ...
  'petali-di-candore-marlene-kuntz-96-97': {
    ...
    presentazione: 'Oltre un anno sulle orme dei Marlene Kuntz dal vivo, sulla strada e nella loro natia provincia di Cuneo. Ritratto dietro le quinte del gruppo musicale piemontese dei Marlene Kuntz, impegnato in un tour per l\'uscita dell\'album Il vile.',
    noteDiRegia: 'Ho affetto per i Marlene non solo per la musica che hanno saputo realizzare, ma soprattutto perché non nascondono il loro provincialismo, senza per questo farne una bandiera.',
    scheda: {
  ...
  'ritratti-dautore-i-fratelli-taviani': {
    ...
    linkEsterni: [
      { label: 'Link esterno', url: 'https://www.imdb.com/it/title/tt1547594/fullcredits/?ref_=tt_cst_sm', type: 'site' },
    ],
  },
  ...
  'indipendenti-new-york-radiografia-di-unalternativa': {
    ...
    linkEsterni: [
      { label: 'Link esterno', url: 'https://www.imdb.com/it/title/tt15289346/fullcredits/?ref_=tt_ov_sm_2#amzn1.imdb.concept.name_credit_group.7caf7d16-5db9-4f4f-8864-d4c6e711c686', type: 'site' },
    ],
  },
  ...
  'memorie-di-una-fabbrica': {
    ...
    linkEsterni: [
      { label: 'Link esterno', url: 'https://www.torinocittadelcinema.it/schedafilm.php?film_id=532&stile=small', type: 'site' },
    ],
  },
